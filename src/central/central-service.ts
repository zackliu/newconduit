...
import { POC_AGENT_SPEC, POC_LOCAL_AGENT_SPEC } from './registries/poc-class-registry';
...
export class CentralService {
  ...
  constructor(options: CentralServiceOptions) {
    ...
    const tenantRuntime = new TenantRuntime({
      ...
      clock,
      agentSpecRegistry: options.agentSpecRegistry ?? new StaticAgentSpecRegistry([POC_AGENT_SPEC, POC_LOCAL_AGENT_SPEC]),
