...
5. Update counterparts only when the task asks for synchronization or when leaving them inconsistent would mislead future work.
6. If only one file changes, state the intentional asymmetry.
